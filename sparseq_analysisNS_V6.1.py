...
#all this does is reformat bowtie outputs for R1 and R2 UMIs
...
def main():
    ...
    #defining outputs
    bctable_fileR1 = open(args.run_folder+"/results/R1UMI_count_table_"+version+".txt", "w") #fileout
    ...
    counts_wbnameR1 = args.run_folder+"/results/"+runID+"_R1UMI_Table.xlsx"
    counts_wbR1 = Workbook()
    ws_countsR1 = counts_wbR1.active
    ws_countsR1.title = "R1UMI_count_"+version

    #R2s
    counts_wbnameR2 = args.run_folder+"/results/"+runID+"_R2UMI_Table.xlsx"
    counts_wbR2 = Workbook()
    ws_countsR2 = counts_wbR2.active
    ws_countsR2.title = "R2UMI_count_"+version
